...
docker exec -it rs_mongo_1 bash -c "echo 'rs.initiate({_id: \"rs0\",members: [{_id: 0, host: \"mini.rx:37017\"},{_id: 1, host: \"mini.rx:37018\"},{_id: 2, host: \"mini.rx:37019\"}]})' | mongosh \"mongodb://admin:1121@localhost:27017/admin\""
