...
docker compose -f docker-compose-shard.yml up -db
...
docker exec -it shard_router bash -c "echo 'sh.addShard(\"RS0/shard_rs00:27018,shard_rs01:27018\")' | mongosh --port 27017"
docker exec -it shard_router bash -c "echo 'sh.addShard(\"RS1/shard_rs10:27018,shard_rs11:27018\")' | mongosh --port 27017"
