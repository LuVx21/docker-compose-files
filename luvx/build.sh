...
cd sentinel-dashboard && sed -i "" 's/1.8.6/1.8.8/g' Dockerfile && docker buildx build -t luvx/sentinel-dashboard:latest -t luvx/sentinel-dashboard:1.8.8 --platform linux/amd64 . --push
